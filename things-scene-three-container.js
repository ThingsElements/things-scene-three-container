...
var ThreeContainer = function (_Container) {
  ...
  _createClass(ThreeContainer, [{
    ...
    value: function makeTextSprite(message, parameters) {
      ...
      var isMarker = parameters.hasOwnProperty("isMarker") ? parameters["isMarker"] : false;
      ...
      this.roundRect(context, cx - tx, cy - fontSize * msgArr.length * 0.5 + ty - 0.28 * fontSize, textWidth, fontSize * msgArr.length * 1.28, radius, borderWidth, borderColor, backgroundColor, 20, isMarker);
    ...
    value: function roundRect(ctx, x, y, w, h, r, borderWidth, borderColor, fillColor, padding, image) {
      ...
      if (image) {
        ...
        ctx.drawImage(image, x + w * 0.5 - image.width * 0.5 - padding, y + h * 0.5 - image.height * 0.5 + padding, image.width + padding * 2, image.height + padding * 2);
      }
