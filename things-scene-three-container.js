...
var ThreeContainer = function (_Container) {
  ...
  _createClass(ThreeContainer, [{
    ...
    value: function onmousedown(e) {
      if (this._controls && this.get('threed')) this._controls.onMouseDown(e);
    }
  }, {
    key: 'onmousemove',
    value: function onmousemove(e) {
      if (this._controls && this.get('threed')) this._controls.onMouseMove(e);
    }
  }, {
    key: 'onmousewheel',
    value: function onmousewheel(e) {
      if (this._controls && this.get('threed')) this._controls.onMouseWheel(e);
    }
  }, {
    key: 'ondragstart',
    value: function ondragstart(e) {
      if (this._controls && this.get('threed')) this._controls.onDragStart(e);
    }
  }, {
    key: 'ondragmove',
    value: function ondragmove(e) {
      if (this._controls && this.get('threed')) this._controls.onDragMove(e);
    }
  }, {
    key: 'ondragend',
    value: function ondragend(e) {
      if (this._controls && this.get('threed')) this._controls.onDragEnd(e);
    }
  }, {
    key: 'ontouchstart',
    value: function ontouchstart(e) {
      if (this._controls && this.get('threed')) this._controls.onTouchStart(e);
    }
  }, {
    key: 'ontouchmove',
    value: function ontouchmove(e) {
      if (this._controls && this.get('threed')) this._controls.onTouchMove(e);
    }
  }, {
    key: 'ontouchend',
    value: function ontouchend(e) {
      if (this._controls && this.get('threed')) this._controls.onTouchEnd(e);
    }
  }, {
    key: 'onkeydown',
    value: function onkeydown(e) {
      if (this._controls && this.get('threed')) this._controls.onKeyDown(e);
    }
  }, {
    key: 'scene3d',
    get: function get() {
